...
def division(marital_status):
    ...
    if marital_status.lower() == "y":
        ...
        if (s_tax(self_income, self_mpf) + s_tax(spouse_income, spouse_mpf)) == min(a):
            ...
            print ("Recommend separate assessment Husbandusing standard tax rate and wife using progressive tax rate",min(a))
        elif (tax(self_income, "n", self_mpf) + s_tax(spouse_income, spouse_mpf)):
            print ("Recommend separate assessment Husbandusing progressive tax rate and wife using standard tax rate",min(a))
        else:
            print ("")
