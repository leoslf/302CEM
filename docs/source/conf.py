...
htmlhelp_basename = 'Revivesceredoc'
...
latex_documents = [
    (master_doc, 'Revivescere.tex', 'Revivescere Documentation',
     'Leo Sin', 'manual'),
]
...
man_pages = [
    (master_doc, 'revivescere', 'Revivescere Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Revivescere', 'Revivescere Documentation',
     author, 'Revivescere', 'One line description of project.',
     'Miscellaneous'),
]
